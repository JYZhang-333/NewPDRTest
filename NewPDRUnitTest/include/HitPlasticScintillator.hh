#ifndef HitPlasticScintillator_hh
#define HitPlasticScintillator_hh

#include "G4THitsCollection.hh"
#include "G4VHit.hh"

class HitPlasticScintillator : public G4VHit {

public:
    HitPlasticScintillator() = default;
    HitPlasticScintillator(const HitPlasticScintillator&) = default;
    ~HitPlasticScintillator() override = default;
...
using HitCollectionPlastic = G4THitsCollection<HitPlasticScintillator>;
